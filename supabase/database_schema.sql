...
CREATE TABLE public.account_deletion_requests (
  ...
  deletion_type text NOT NULL DEFAULT 'soft'::text CHECK (deletion_type = ANY (ARRAY['soft'::text, 'hard'::text])),
  reason text,
  requested_ip text,
  ...
  CONSTRAINT account_deletion_requests_broker_id_fkey FOREIGN KEY (broker_id) REFERENCES public.brokers(id),
...
CREATE TABLE public.brokers (
  ...
  broker_code text NOT NULL UNIQUE CHECK (broker_code = upper(broker_code)),
...
CREATE TABLE public.subscription_plans (
  ...
  payment_provider USER-DEFINED DEFAULT 'razorpay'::payment_provider_type,
