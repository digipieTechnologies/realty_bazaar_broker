            ...
            child: Center(
              child: Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const Icon(Icons.star_rounded, size: 14.0, color: AppColors.warning),
        ...
        return Row(
          ...
          children: [
            Container(
              ...
              height: 20.0,
              decoration: BoxDecoration(
                color: isPopular ? AppColors.success.withValues(alpha: 0.15) : AppColors.successLight,
            ...
            Expanded(
              child: Text(
                plan.benefits[index],
                style: AppTextStyles.body2.copyWith(
                  color: isPopular ? AppColors.background : AppColors.textPrimary,
                  fontSize: 13.0,
                  height: 1.4,
                ),
              ),
