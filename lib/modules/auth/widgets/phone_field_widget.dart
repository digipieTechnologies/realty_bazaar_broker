...
class _PhoneFieldWidgetState extends State<PhoneFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return AppTextField(
      ...
      autofillHints: widget.autofillHints ?? const [AutofillHints.telephoneNumber],
      prefixIcon: ExcludeFocusTraversal(
        child: ClipRRect(
      ...
      validator: (val) {
        ...
        if (cleanVal.length < _selectedCountry.minLength || cleanVal.length > _selectedCountry.maxLength) {
